...
public class Load_MainTable_Tests_Test {
  ...
  public void then_Entries_has_1_rows() {
    ...
    Assertions.assertEquals(Integer.valueOf(1), Integer.valueOf(actualRows.size()));
    // {
  ...
  public void then_Entries_has_2_rows() {
    List<JabRefMainTableViewModelEntriesRow> actualRows = this.sut.getEntriesTableRows();
    Assertions.assertEquals(Integer.valueOf(2), Integer.valueOf(actualRows.size()));
    // {
    JabRefMainTableViewModelEntriesRow row0 = actualRows.get(1 - 1);
